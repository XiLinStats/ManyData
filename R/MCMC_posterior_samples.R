...
#'
#'
run_MH_MCMC <- function(startval, iterations, dat_obs, dat_exp, eta){
  ...
  FI_obs <- ApproxFI(masks = msks_obs, theta = theta_obs, mm = mm_obs, dat = dat_obs, delta = 1e-4)

  sigma <- 5 * solve(FI_exp + eta *FI_obs)
  print(sigma)
  # print(sd)
