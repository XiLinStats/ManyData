...
data_obs <- causalSamp(5000,formulas = forms_obs,pars = pars_obs, family = list(1,c(5,5),1,1))
...
# X           0.9376120 0.04426501 21.181784 1.976703e-95
# C1          0.1194004 0.06815873  1.751799 7.986979e-02
# X:C1        0.6746419 0.07731291  8.726122 3.538950e-18
